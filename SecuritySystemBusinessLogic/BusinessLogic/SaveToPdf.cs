...
namespace SecuritySystemBusinessLogic.BusinessLogic
{
    class SaveToPdf
    {
        ...
        public static void CreateDoc(PdfInfo info)
        {
            ...
            {
                Table = table,
                Texts = new List<string> { "Комплектация", "Устройство", "Количество" },
                Style = "NormalTitle",
            ...
            foreach (var equipment in info.Equipments)
            {
                ...
                {
                    Table = table,
                    Texts = new List<string> { equipment.EquipmentName, equipment.DeviceName, equipment.DeviceCount.ToString() },
                    Style = "Normal",
